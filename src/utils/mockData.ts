...
export const mockEvents: Event[] = [
  ...
  },
  {
    ...
    end: '2025-01-10T21:00:00Z',
    allDay: false,
    location: '本社カフェテリア',
    description: '2025年のキックオフと新年のお祝い。軽食と飲み物をご用意しています。',
    attendees: ['yamada@example.com', 'sato@example.com', 'suzuki@example.com'],
    contactIds: [],
  ...
  {
    id: '9',
    title: '2025年度第1四半期戦略会議',
    start: '2025-04-01T09:00:00Z',
    end: '2025-04-01T17:00:00Z',
    allDay: false,
    location: '第1会議室',
    description: '新年度の戦略、目標設定、および主要プロジェクトのレビュー。',
    attendees: ['yamada@example.com', 'sato@example.com', 'suzuki@example.com', 'tanaka@techinnovation.co.jp'],
    contactIds: ['1'],
  ...
  },
  {
    ...
    allDay: true,
    location: '',
    description: '全社的なゴールデンウィーク休暇期間です。',
    attendees: [],
    contactIds: [],
    createdAt: '2025-01-20T11:00:00Z',
    updatedAt: '2025-01-20T11:00:00Z',
    color: '#064e3b' // 暗い緑 (休日など)
  },
  {
    id: '11',
    title: '梅雨入り前のチームビルディングイベント',
    start: '2025-06-07T13:00:00Z',
    end: '2025-06-07T17:00:00Z',
    allDay: false,
    location: '〇〇公園 バーベキューエリア',
    description: 'チームメンバー間の親睦を深めるためのアウトドアアクティビティ。雨天時は社内レクリエーションルームに変更。',
    attendees: ['yamada@example.com', 'sato@example.com', 'suzuki@example.com', 'kobayashi@techinnovation.co.jp', 'watanabe@maruyama-corp.co.jp'],
    contactIds: ['6', '7'],
  ...
  },
  {
    ...
    end: '2025-06-12T12:00:00Z',
    allDay: false,
    location: 'マーケティング部会議室',
    description: '7月開催予定の新製品発表会の進行確認、デモ準備、広報戦略の最終調整。',
    attendees: ['sato@example.com', 'kato@midorikawa-pharma.co.jp'],
    contactIds: ['8'],
  ...
  },
  {
    ...
    allDay: false,
    location: '本社 大ホール',
    description: '定時株主総会の開催。経営陣による事業報告および質疑応答。',
    attendees: ['yamada@example.com'], // 主要な出席者のみ
    contactIds: [],
    createdAt: '2025-04-15T16:00:00Z',
    updatedAt: '2025-04-15T16:00:00Z',
    color: '#ef4444' // 赤 (重要イベント)
  },
  {
    id: '14',
    title: '上半期業績レビュー会議',
    start: '2025-06-27T09:30:00Z',
    end: '2025-06-27T17:30:00Z',
    allDay: false,
    location: '役員会議室',
    description: '2025年度上半期の業績報告と下半期に向けた戦略修正の検討。',
    attendees: ['yamada@example.com', 'sato@example.com', 'suzuki@example.com'],
    contactIds: [],
  ...
  },
  {
    ...
    allDay: true,
    location: '',
    description: '6月分の請求書発行および関連処理の最終締め切り日。',
    attendees: [],
    contactIds: [],
    createdAt: '2025-06-01T00:00:00Z',
    updatedAt: '2025-06-01T00:00:00Z',
    color: '#4b5563' // グレー (タスク・リマインダー系)
  }
];
